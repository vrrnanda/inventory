...
<div class="col-lg-10 mt-2">
    ...
    <form action="/transaksisoftware/simpan" method="POST">
        @csrf
        <div class="row">
            <div class="col">
                <label>Kode Transkasi</label>
                <input type="text" name="kodets" class="form-control" placeholder="Kode Transaksi" aria-label="no spk">
            </div>
            <div class="col">
            <label>Tanggal Pembelian</label>
                <input type="date" name="tgl_pembelian" class="form-control" placeholder="Tanggal" aria-label="Last name">
            </div>
        </div>
        <div class="form-group mt-2">
            <label>Nama Software</label>
            <input type="text" name="namasw" class="form-control" placeholder="Masukkan Nama Hardware" required>
        </div>
